...
const Index = () => {
  ...
  const { trips, isLoading: tripsLoading, addTrip } = useTrips();
  const { operationalCosts, isLoading: costsLoading, addOperationalCost } = useOperationalCosts();
      ...
      <div className="min-h-screen flex w-full bg-gradient-to-br from-slate-50 to-slate-100">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <main className="flex-1 p-6 overflow-auto">
            {currentTab === 'vehicles' ? renderVehicles() : 
